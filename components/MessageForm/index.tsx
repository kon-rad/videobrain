...
const MessageForm = () => {
  ...
  return (
    ...
    >
      <div className=" border-gray-200 h-[130px] rounded-t-xl backdrop-blur border-t border-l border-r border-gray-500/10 bg-white supports-backdrop-blur:bg-white/95 p-5">
